...
const SEED_LIFT_LIBRARY: SeedFamily[] = [
  ...
  { name: 'Overhead Tricep Extension', variants: ['dumbbell', 'cable'] },
  { name: 'Skullcrusher', variants: ['barbell', 'dumbbell'] },
  { name: 'Pec Deck', variants: ['machine'] },
  { name: 'Rear Delt Fly', variants: ['cable', 'dumbbell', 'machine'] },
...
// PPL shaped to Cody's actual format (machine bench / OHP / squat / lat
// pulldown; barbell RDL; cable-cable upper-body superset and dumbbell-dumbbell
// secondary superset). Mon=Pull, Tue=Push, Wed=Legs, Thu=Pull (variation),
// Fri=Push (variation), Sat=Legs (variation), Sun=Rest.
const PPL_SEED_PROGRAM: SeedSlot[] = [
  ...
  },
  {
    ...
    isRest: false,
    lifts: [
      { familyName: 'Bench Press', variantKind: 'machine', sets: 5, repsMin: 5, repsMax: 5 },
      ...
      { familyName: 'Tricep Pushdown', variantKind: 'cable', sets: 3, repsMin: 8, repsMax: 12 },
      { familyName: 'Lateral Raise', variantKind: 'cable', sets: 3, repsMin: 15, repsMax: 20 },
      {
        familyName: 'Overhead Tricep Extension',
        variantKind: 'dumbbell',
        sets: 3,
        repsMin: 8,
        repsMax: 12,
      },
      { familyName: 'Lateral Raise', variantKind: 'dumbbell', sets: 3, repsMin: 15, repsMax: 20 },
      { familyName: 'Pec Deck', variantKind: 'machine', sets: 3, repsMin: 12, repsMax: 12 },
  ...
  },
  {
    ...
    isRest: false,
    lifts: [
      { familyName: 'Squat', variantKind: 'machine', sets: 3, repsMin: 5, repsMax: 5 },
      { familyName: 'Romanian Deadlift', variantKind: 'barbell', sets: 3, repsMin: 8, repsMax: 12 },
      { familyName: 'Leg Press', variantKind: 'machine', sets: 3, repsMin: 8, repsMax: 12 },
      { familyName: 'Leg Curl', variantKind: 'machine', sets: 3, repsMin: 8, repsMax: 12 },
      { familyName: 'Calf Raise', variantKind: 'machine', sets: 5, repsMin: 8, repsMax: 12 },
    ],
  },
  {
  ...
  },
  {
    ...
    isRest: false,
    lifts: [
      { familyName: 'Shoulder Press', variantKind: 'machine', sets: 5, repsMin: 5, repsMax: 5 },
      { familyName: 'Bench Press', variantKind: 'machine', sets: 3, repsMin: 8, repsMax: 12 },
      {
        familyName: 'Incline Bench Press',
        variantKind: 'dumbbell',
